...
const Navbar: React.FC = () => {
  ...
  const getRoleLabel = () => {
    if (role === "worker") return "Service Provider";
        ...
        <div className="flex justify-between h-20">
          <div className="flex items-center">
            <Link to="/" className="flex items-center space-x-3 group">
              <div className="bg-primary-600 text-white font-bold text-2xl px-3 py-1.5 rounded-xl shadow-lg group-hover:scale-110 transition-transform">
                K
              </div>
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  className="flex items-center space-x-2 px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-xl transition-all font-semibold"
                >
                  <LogOut size={18} />
                  <span>Logout</span>
                </button>
